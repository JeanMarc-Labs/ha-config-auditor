...
(function () {
  ...
  .cfg-save-status.error { background: rgba(239,68,68,0.12); color: #dc2626; border: 1px solid rgba(239,68,68,0.3); }
            ...
            <div style="display:flex;align-items:center;gap:10px;padding:10px 16px;border-bottom:1px solid var(--divider-color);flex-shrink:0;flex-wrap:wrap;background:var(--secondary-background-color);">
              ...
              <div style="display:flex;gap:6px;margin-left:8px;">
                ...
                <button id="graph-issues-toggle" style="padding:5px 10px;border-radius:8px;border:1px solid var(--divider-color);background:var(--card-background-color);color:var(--primary-text-color);font-size:12px;cursor:pointer;">
                  ⚠️ ${this.t('filter_type.issues_only')}
                </button>
                <!-- Reset zoom -->
          ...
          <div id="tab-batteries" class="tab-content">
            ...
            <div style="padding:0 20px 20px;overflow-x:auto;">
              <table style="width:100%;border-collapse:collapse;font-size:13px;min-width:420px;">
                <thead>
                  <tr style="border-bottom:2px solid var(--divider-color);">
                    <th style="padding:8px 10px;text-align:left;color:var(--secondary-text-color);font-weight:600;">${this.t('battery.device')}</th>
                    <th style="padding:8px 10px;text-align:center;color:var(--secondary-text-color);font-weight:600;min-width:120px;">${this.t('battery.level')}</th>
                    <th style="padding:8px 10px;text-align:center;color:var(--secondary-text-color);font-weight:600;min-width:90px;">${this.t('battery.status')}</th>
                  </tr>
                </thead>
                <tbody id="bat-tbody">
      ...
      <table style="width:100%;border-collapse:collapse;margin-top:8px;font-size:13px;">
        <thead>
          <tr style="border-bottom:2px solid var(--divider-color);text-align:left;">
            ...
            <th style="padding:8px 12px;text-align:right;">${this.t('tables.stats')}</th>
            <th style="padding:8px 12px;text-align:right;">${this.t('tables.size')}</th>
            <th style="padding:8px 12px;text-align:center;">${this.t('tables.actions')}</th>
          </tr>
        </thead>
        <tbody>
            ...
            <tr style="border-bottom:1px solid var(--divider-color);">
              ...
              <td style="padding:8px 12px;text-align:center;">
                <button class="recorder-purge-one" data-entity="${this.escapeHtml(o.entity_id)}"
                  ...
                  <ha-icon icon="mdi:delete-outline" style="--mdc-icon-size:13px;"></ha-icon> ${this.t('recorder.purge_button_alone')}
                </button>
              </td>
            </tr>`).join('')}
        </tbody>
    ...
    _graphShowSidebar(node) {
      ...
      const typeLabels = {
        automation: 'Automation', script: 'Script', scene: this.t('graph.type_scene'),
