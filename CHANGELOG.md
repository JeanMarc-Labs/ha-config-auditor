...
- **Internationalization system** — complete rewrite
- **13 languages support** — French, English, Spanish, German, Italian, Portuguese, Dutch, Russian, Chinese, Japanese, Polish, Swedish, Danish
- **New feature** - Possibility for all elements to which a label can be added to be ignored by the H.A.C.A. scan by adding the label: `haca_ignore`

### Fixed

- **Bug** - fixes the return error as a percentage of a battery's power instead of watts 
...
## [1.0.3] — 2026-03-03 — Hard  -coded text internationalization and bug fixing

## [1.0.2] — 2026-03-02 — Hard-coded text internationalization and bug fixing

## [1.0.1] — 2026-03-01 — Internationalization of hard-coded texts
...
- **Dashboard Analyzer** (Module 8) — missing entities in Lovelace views
- **Event Monitoring** (Module 9) — debounced auto-scan on HA config changes
- **Recorder Analyzer** (Module 10) — orphaned entities in SQLite, wasted space estimation, one-click purge
- **Audit History** (Module 11) — timestamped snapshots, health score trend chart, individual/bulk deletion
...
- Custom HA panel with 9 main tabs and per-category sub-tabs
