...
- **La correction d'une entité zombie depuis le panneau pouvait désactiver l'automatisation corrigée, en annonçant un succès** — retirer l'entité pouvait laisser un déclencheur d'état sans entité, que Home Assistant désactive au rechargement alors que le rechargement, lui, réussit ; et un rechargement en échec laissait le fichier modifié en place. La correction passe désormais par la même vérification que les outils MCP : ce que Home Assistant refuserait n'est pas écrit et le panneau en affiche la raison, et un rechargement en échec remet le fichier d'origine.
